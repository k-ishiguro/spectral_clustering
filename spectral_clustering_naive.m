function Z = spectral_clustering_naive(X, K, fig_flag)
% Z = spectral_clustering_naive(X, K, fig_flag)
%
% implementation of the spectral clustering with unnormalized graph
% laplacian. 
...
%% compute the un-normalized matrix L
L = D - X;
...
if(fig_flag)
    ...
    ylabel('i')
    axis ij
    title('Un-normalized Laplacian matrix L')
    colorbar
end
